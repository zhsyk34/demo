...
public class TestSimple {
	...
	// @Test
	// public void init() {
	// C3p0Plugin cp = new C3p0Plugin("jdbc:mysql://localhost/test", "root",
	// "root");
	// cp.start();
	//
	...
	// init();
	// Record r = new Record().set("id", 1).set("age", 33).set("name",
	// "zhsy").set("birthday", new Date());
	...
	// System.out.println(student);
	//
	// Record r2 = new Record().set("id", 233).set("age", 34).set("name",
	// "zhsy").set("address", "海边");
